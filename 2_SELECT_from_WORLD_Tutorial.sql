/*
1. Introduction
    Read the notes about this table. Observe the result of running this SQL 
...
2. Large Contries
    ...
    have a population of at least 200 million. 200 million is 200000000, there
    are eight zeros.
*/
select name 
from world
...
8. One or the other (but not both)
    Exclusive OR (XOR). Show the countries that are big by area (more than 3 
